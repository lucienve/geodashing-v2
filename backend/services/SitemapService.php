...
class SitemapService
{
    ...
    public function __construct(PDO $pdo = null, string $baseUrl = "https://www.geodashing.org")
    {
        // Allow dependency injection for testing, fallback to standard DB connection
        if ($pdo === null) {
            $host = getenv('DB_HOST') ?: 'localhost';
            $db   = getenv('DB_NAME') ?: 'geodashing';
            $user = getenv('DB_USER') ?: 'geodashing_user';
